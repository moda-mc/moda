...
import com.mineglade.moda.chat.emotes.EmotePlaceholders;
...
public class ChatEvent implements Listener {
	...
	public void onChat(AsyncPlayerChatEvent event) {
		...
		Placeholder playerStatistics = new Placeholder("{player-statistics}", Moda.instance.getConfig().getString("player-statistics"));
		...
		for (Player recipient : event.getRecipients()) {
			recipient.spigot()
					.sendMessage(Chat.toComponentWithPapiPlaceholders(Moda.instance.getConfig(), "chat.format", player, 
